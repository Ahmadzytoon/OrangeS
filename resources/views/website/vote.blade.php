    ...
    <div class="row" style="justify-content: center;">
            <div class="col-lg-6 col-md-8">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                ...
                <div style="
                margin-top: 29px;
            ">                  <label class="lablered" for="contactChoice1" style="
                  margin-left: 20px;    font-size: 15px;
              ">Very Poor</label>                  <input type="radio" id="radio" name="adaptation_to_the_market" value="1" />
                  
                  <input type="radio" id="radio" name="adaptation_to_the_market" value="2" />
                  {{-- <label  class="lablered" for="contactChoice2">2</label> --}}
                  <input type="radio" id="radio" name="adaptation_to_the_market" value="3" />
                  {{-- <label  class="lablered" for="contactChoice3">3</label> --}}
                  <input type="radio" id="radio" name="adaptation_to_the_market" value="4" />
                  {{-- <label  class="lablered" for="contactChoice3">4</label> --}}
                  <input type="radio" id="radio" name="adaptation_to_the_market" value="5" />
                  <label class="lablered" for="contactChoice3" style="
                  margin-left: 20px;    font-size: 15px;
              ">Very good</label>  
                          </div>
              </div>
            ...
            ">                  <label class="lablered" for="contactChoice1" style="
                  margin-left: 20px;    font-size: 15px;
              ">Very Poor</label>            
                    <input type="radio" id="radio" name="robustness_of_the_economic_model" value="1" />
            ...
            <div class=" col-lg-6 col-md-8 mt-4 mt-md-0">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  <input type="radio" id="radio" name="solution_maturity" value="1" />
                  <label class="lablered" for="contactChoice1">1</label>
                  ...
                  <label  class="lablered" for="contactChoice3">5</label>
              </div>              </div>
            </div>
            <div class="col-lg-6 col-md-8 mt-4 mt-md-0">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  <input type="radio" id="radio" name="scalability_and_innovation" value="1" />
                  <label class="lablered" for="contactChoice1">1</label>
            ...
            <div class="col-lg-6 col-md-8 mt-4 mt-md-0">
              <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                ...
                <div style="
                margin-top: 29px;
            ">       <label class="lablered" for="contactChoice1" style="margin-left: 15px;    font-size: 15px;">Very Poor</label>            
<input type="radio" id="radio" name="pitch_quality" value="1" style="
margin-left: 3px;
">                    <label  class="lablered" for="contactChoice2" style="margin-left: 15px;    font-size: 15px;">Poor</label>

<input type="radio" id="radio" name="pitch_quality" value="2" style="
    margin-left: 3px;
">                  <label  class="lablered" for="contactChoice3" style="margin-left: 15px;    font-size: 15px;">Fair</label>

<input type="radio" id="radio" name="pitch_quality" value="3" style="
    margin-left: 3px;
">                  <label  class="lablered" for="contactChoice3" style="margin-left: 15px;    font-size: 15px;">Good</label>

<input type="radio" id="radio" name="pitch_quality" value="4" style="
    margin-left: 3px;
">                  <label class="lablered" for="contactChoice3" style="
                  margin-left: 20px;    font-size: 15px;
              ">Very Good</label> 
<input type="radio" id="radio" name="pitch_quality" value="5" style="
margin-left: 3px;
">                   
                          </div>        
